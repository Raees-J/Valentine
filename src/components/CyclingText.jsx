...
const CyclingText = () => {
  ...
  return (
    <div className="text-center space-y-4 md:space-y-6 px-4">
      <motion.h2 
        className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light tracking-wide text-white/95"
      ...
      <div className="h-16 sm:h-20 md:h-24 flex items-center justify-center">
        ...
        >
          {displayedText}
          <motion.span
            className="inline-block w-0.5 sm:w-1 h-12 sm:h-14 md:h-16 lg:h-20 bg-white/90 ml-1 sm:ml-2"
